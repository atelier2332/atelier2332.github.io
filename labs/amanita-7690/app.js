...
var head = new GlassCanvas(new THREE.ImageUtils.loadTexture('img/galmasani.png'), 100);
head.mesh.position.set(200, 200, -400);
head.mesh.scale.set(3, 3, 3);
scene.add(head.mesh);

var plum = new GlassCanvas(new THREE.ImageUtils.loadTexture('img/otomon.png'), 150);
plum.mesh.position.set(200, 200, -500);
plum.mesh.scale.set(3, 3, 3);
plum.mesh.rotation.set(0, 40, 0);
scene.add(plum.mesh);
