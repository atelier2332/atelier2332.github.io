var App0 = (function(){
  ...
  return{
    init: function(){
      ...
      var mapHeight = THREE.ImageUtils.loadTexture('arp/1/assets/textures/0_bump.png');
      mapHeight.anisotropy = 4;
      mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
      mapHeight.format = THREE.RGBFormat;

      var mapNormal = THREE.ImageUtils.loadTexture('arp/1/assets/textures/0_normal.png');
      mapNormal.anisotropy = 4;
      mapNormal.wrapS = mapNormal.wrapT = THREE.RepeatWrapping;
      mapNormal.format = THREE.RGBFormat;

      var mesh = null;
      var texture = new THREE.ImageUtils.loadTexture('arp/1/assets/textures/0.png', undefined, function(e){
